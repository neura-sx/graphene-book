...
* We assume that you have set up a wallet in the CLI and imported the private key of a LTM account with some BTS funds in it. We will refer to this account as `your-base-account`.
