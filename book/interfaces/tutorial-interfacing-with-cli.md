...
* We assume that you have the private keys for two existing accounts and at least one of them has some funds. Please refer to FAQs if you are not sure how to retrieve private keys from the GUI. 
