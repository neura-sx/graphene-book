...
* We assume that you have active private keys for two existing accounts and at least one of them has some funds. Please refer to [FAQs](FAQs.md#retrieving-private-keys-from-the-gui) if you are not sure how to retrieve private keys from the GUI.
